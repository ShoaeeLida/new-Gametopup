                  ...
                  <tr>
                    <td class="whitespace-nowrap py-4 pl-6 pr-3 text-sm">
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          <div class="font-medium text-gray-900">Amin Hamidi</div>
                          <div class="text-gray-500">igame@gametopup.com</div>
                        </div>
                      </div>
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div class="text-gray-900">iGame</div>
                    ...
                    <td class="whitespace-nowrap py-4 pl-6 pr-3 text-sm">
                      <div class="flex items-center">
                        <div class="h-10 w-10 flex-shrink-0">
                          <img
                            class="h-10 w-10 rounded-full"
                            src="assets/images/dynamic/heaven-account.jpg"
                            alt=""
                          />
                        </div>
                        <div class="ml-4">
                          <div class="font-medium text-gray-900">Farzam Fallahi</div>
                          <div class="text-gray-500">heavenacc@gametopup.com</div>
                        </div>
                      </div>
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div class="text-gray-900">Heaven Store</div>
                      <div class="text-gray-500">Premium Accounts</div>
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <span
