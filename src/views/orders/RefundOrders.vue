...
export default defineComponent({
  ...
  setup() {
    ...
    async function fillDataTable(
      props: RequestProp = orderService.currentRefundRequestProp
    ) {
      props.pagination.sortBy = "createDateTime";
      props.pagination.descending = true;
      var response = await orderService.tableRefundAsync(props);
      quasarTable.value.setData(
        response.data,
        response.total,
        orderService.currentRefundRequestProp.pagination
      );
    }
